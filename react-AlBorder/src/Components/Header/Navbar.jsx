                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0 col-md-7 d-flex justify-content-between">
                                <li className="nav-item">
                                    <NavLink className="nav-link" to={"/Quienes-Somos"}>{tagUno}</NavLink>
                                </li>
                                <li className="nav-item dropdown">
                                    <NavLink className="nav-link dropdown-toggle" role="button" to={"/Productos"} data-bs-toggle="dropdown" aria-expanded="false">{tagDos}
                                    </NavLink>
                                    <ul className="dropdown-menu">
                                        <li><NavLink className="dropdown-item" to={"/category/:id"}>Juguetes</NavLink></li>
                                        <li><NavLink className="dropdown-item" to={"/"}>Alimentos</NavLink></li>
                                        <li><NavLink className="dropdown-item" to={"/"}>Accesorios</NavLink></li>
                                    </ul>
                                </li>
                                <li className="nav-item">
                                    <NavLink className="nav-link" to={"/Clientes"}>{tagTres}</NavLink>
                                </li>
                                <li className="nav-item">
                                    <NavLink className="nav-link" to={"/Contáctanos"}>{tagCuatro}</NavLink>
                                </li>
                            </ul>
